...
def sample_pipeline() -> DeepsetPipeline:
    ...
    user = DeepsetUser(user_id="user-123", given_name="Test", family_name="User", email="test@example.com")
...
class TestPipelineHandle:
    ...
    def test_attribute_error_for_missing_attribute(
        self, sample_pipeline: DeepsetPipeline, pipeline_resource: PipelineResource
    ) -> None:
    ...
    def test_handle_maintains_pipeline_type(
        self, sample_pipeline: DeepsetPipeline, pipeline_resource: PipelineResource
    ) -> None:
    ...
    def test_handle_resource_access(
        self, sample_pipeline: DeepsetPipeline, pipeline_resource: PipelineResource
    ) -> None:
