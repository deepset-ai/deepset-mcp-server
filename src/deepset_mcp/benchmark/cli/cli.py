...
from deepset_mcp.benchmark.cli.commands.agents import create_agents_app
from deepset_mcp.benchmark.cli.commands.resources import create_index_app, create_pipeline_app
from deepset_mcp.benchmark.cli.commands.tests import create_tests_app
